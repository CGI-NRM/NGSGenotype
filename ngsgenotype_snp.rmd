...
# Load data:
genotypeGenind <- adegenet::df2genind(allGenotypes[, -c(1)], ploidy = 2, ind.names = allGenotypes$Sample, sep = "", pop = LETTERS[1:length(allGenotypes$Sample)])
genotypeGenind
genotypeGencln <- poppr::as.genclone(genotypeGenind)
...
View(cbind(genotypeGencln@mlg@mlg$contracted, genotypeGencln$tab))
View(poppr::mlg.table(genotypeGencln))
